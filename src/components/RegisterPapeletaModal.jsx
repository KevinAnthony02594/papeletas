            ...
            <form id="papeleta-form" onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6">
              ...
              <fieldset className="space-y-4">
                  ...
                  <FormField label="Lugar de Destino (*)">
                      <input type="text" name="lugar_destino" value={formData.lugar_destino} onChange={handleChange} required className="w-full rounded-md border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 focus:border-blue-500 focus:ring-blue-500"/>
                  </FormField>
              </fieldset>
